...
export const getBucketJsonLd = ({ s3req, endpoint, signer, bucket }) =>
  getRevisionData({
    s3req,
    endpoint,
    signer,
    bucket: 'quilt-open-data-bucket',
    key: `${PACKAGES_PREFIX}roda/${bucket}/latest`,
    maxKeys: 0,
  }).then((d) => d.user_meta && d.user_meta['json-ld'])
